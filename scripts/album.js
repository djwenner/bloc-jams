...
var setCurrentAlbum = function(album) {
    ...
    var albumReleaseInfo =
        document.getElementsByClassName('album-view-release-info')[0];
    ...
    for (var i = 0; i < album.songs.length; i++) {
        albumSongList.innerHTML += createSongRow(i + 1,
    ...
    switch (element.className) {
      ...
      case "song-item-duration":
          return findParentByClassName(element,
              "album-view-song-item").querySelector(".song-item-number");
...
window.onload = function() {
    ...
    songListContainer.addEventListener('mouseover', function(event) {
      ...
      if (event.target.parentElement.className === 'album-view-song-item') {
          ...
          if (songItem.getAttribute("data-song-number") !==
